...
<%@ page import="org.example.services.AccountService" %>
<%@ page import="org.example.remotes.StorageTarget" %>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Name: <%= account.getName() %></li>
                <li class="list-group-item">Account Number: <%= account.getAccountNumber() %></li>
                <li class="list-group-item">Customer ID: <%= account.getCustomerId() %></li>
                <li class="list-group-item">Email: <%= account.getEmail() %></li>
                <li class="list-group-item">Balance: <%= account.getBalance() %></li>
            </ul>
        </div>
    </div>
</div>
